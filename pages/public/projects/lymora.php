                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="tp-breadcrumb-s9-wrap text-center">
                                    <h2 class="tp-breadcrumb-s9-title mb-35 tp-split-title"><a href="https://lymora.tech/">Lymora</a></h2>
    ...
    <div class="row">
                ...
                <div class="tp-project-details-cetagory">
                    <ul>
                        ...
                        <li>
                            ...
                            <span>Lymora Inc.</span>
                        </li>
                        <li>
                            <span class="spacing">Industry :</span>
                            <span>Education, Technology & Innovation</span>
                        </li>
                         <li>
                                    <span class="spacing">Go to site :</span>
                                    <span style="text-decoration: underline;"><a href="https://lymora.tech/">Lymora</a></span>
                                </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="col-lg-8">
            <div class="tp-project-details-overview-wrap ml-90 mb-30">
                ...
                <p>
                    Lymora is a digital infrastructure initiative founded on the belief that African
                    institutions and students deserve intelligent systems that do more than function —
                    systems that evolve, adapt, and scale with purpose. The platform serves as a
                    foundation for building modern digital solutions across education, research,
                    and enterprise sectors.
                </p>

                <p>
                    Designed with a systems-first approach, Lymora focuses on creating interoperable
                    products and services that empower learning, enable innovation, and support
                    long-term institutional growth. Emphasis is placed on performance, accessibility,
                    and sustainability to ensure relevance across diverse African contexts.
                </p>

                <p>
                    By combining thoughtful design, scalable architecture, and forward-looking
                    technology, Lymora aims to power the next generation of digital ecosystems
                    across the continent — building infrastructure not just for today, but for
                    Africa’s future.
                </p>
            </div>
        </div>
