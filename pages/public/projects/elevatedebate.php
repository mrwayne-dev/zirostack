                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="tp-breadcrumb-s9-wrap text-center">
                                    <h2 class="tp-breadcrumb-s9-title mb-35 tp-split-title"><a href="https://elevatedebate.com/">Elevate Debate</a></h2>
    ...
    <div class="row">
                        ...
                        <div class="tp-project-details-cetagory">
                            <ul>
                                <li>
                                    ...
                                    <span>Elevate Debate</span>
                                </li>
                                <li>
                                    <span class="spacing">Category :</span>
                                    <span>Web Application / Discussion Platform</span>
                                </li>
                                <li>
                                ...
                                <li>
                                    <span class="spacing">Industry :</span>
                                     <span>Education, Media & Public Discourse</span>
                                </li>
                                <li>
                                    <span class="spacing">Go to site :</span>
                                    <span style="text-decoration: underline;"><a href="https://elevatedebate.com/">Elevate Debate</a></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="col-lg-8">
            <div class="tp-project-details-overview-wrap ml-90 mb-30">
                ...
                <p>
                    Elevate Debate is a modern online discussion platform designed to encourage
                    thoughtful argumentation, critical reasoning, and civil discourse across a
                    wide range of topics including politics, religion, business, education, and
                    emerging technologies.
                </p>

                <p>
                    The platform allows users to read existing debates, start new discussions,
                    and engage with opposing viewpoints in a structured and transparent format.
                    Each debate is organized by topic and tags, making it easy for users to explore
                    conversations that matter to them while maintaining clarity and focus.
                </p>

                <p>
                    Featuring user accounts, commenting systems, engagement metrics, and an
                    administrative blog, Elevate Debate promotes balanced examination of ideas
                    rather than emotional reactions. The project was built to foster meaningful
                    dialogue and intellectual growth in an increasingly polarized digital space.
                </p>
            </div>
        </div>
    </div>
