    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="tp-project-details-overview-wrap ml-90 mb-30">
                ...
                <p>
                    GameRig HQ is a comprehensive e-commerce platform specializing in custom-built
                    gaming PCs, high-performance laptops, and premium computer hardware. The project
                    was designed to serve gamers, creators, and professionals seeking tailored
                    systems built to exact performance requirements.
                </p>

                <p>
                    The platform features a wide range of products including custom gaming desktops,
                    gaming and business laptops, PC components, monitors, and accessories. Users can
                    explore detailed product configurations, compare specifications, and place
                    orders with transparent pricing and real-time order status updates.
                </p>

                <p>
                    Emphasis was placed on user experience, trust, and reliability, with clear
                    delivery timelines, responsive customer support, and post-purchase assistance.
                    GameRig HQ positions itself as a one-stop destination for high-quality hardware,
                    competitive pricing, and professionally assembled custom systems.
                </p>
            </div>
        </div>
    </div>
