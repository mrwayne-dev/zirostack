    ...
    <div class="row">
                ...
                <div class="tp-project-details-cetagory">
                    <ul>
                        ...
                        <li>
                            ...
                            <span>Rivers State Government</span>
                        </li>
                        <li>
        ...
        <div class="col-lg-8">
            <div class="tp-project-details-overview-wrap ml-90 mb-30">
                ...
                <p>
                    The Rivers State Administration of Criminal Justice Monitoring Council (ACJMC)
                    platform is an official government digital system established to promote
                    transparency, accountability, and compliance within the criminal justice
                    institutions of Rivers State.
                </p>

                <p>
                    Developed to serve as a central oversight and reporting platform, the website
                    enables the monitoring of criminal justice processes involving law enforcement
                    agencies, the judiciary, correctional services, and the Ministry of Justice.
                    It supports public reporting of incidents, institutional accountability, and
                    adherence to statutory provisions under the Administration of Criminal Justice Law.
                </p>

                <p>
                    The platform reinforces public trust by safeguarding the rights of suspects,
                    defendants, victims, and the State while promoting speedy dispensation of cases,
                    decongestion of custodial centers, and the continuous improvement of the criminal
                    justice system across Rivers State.
                </p>
            </div>
        </div>
    </div>
