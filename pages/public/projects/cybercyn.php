    ...
    <div class="row">
                ...
                <div class="tp-project-details-cetagory">
                    <ul>
                        ...
                        <li>
                            ...
                            <span>Digital Agency / Web Solutions</span>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <span>Technology, Digital Media & Web Services</span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="col-lg-8">
            <div class="tp-project-details-overview-wrap ml-90 mb-30">
                ...
                <p>
                    CyberCyn is a digital solutions brand focused on building high-quality websites
                    designed to attract, engage, and convert target audiences. The project centers
                    on delivering visually compelling and performance-driven web experiences tailored
                    to specific business goals.
                </p>

                <p>
                    The platform supports a wide range of digital products including e-commerce
                    stores, banking and financial platforms, blogs, landing pages, and custom web
                    applications. Emphasis is placed on responsive design, clarity of messaging,
                    and usability across devices.
                </p>

                <p>
                    By combining modern design principles with practical development standards,
                    CyberCyn helps brands establish a strong online presence that not only looks
                    professional but also drives measurable growth and audience engagement.
                </p>
            </div>
        </div>
    </div>
